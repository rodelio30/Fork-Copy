        ...
        $date_of_birth    = $_POST['dob'];
            ...
            if ($check_email_result->num_rows > 0) {
                $error_message = "Error: Email already exists";
                    ...
                    $sql = "INSERT INTO users (full_name, email, password, employee_id, date_of_birth, date_of_record_update) VALUES ('$name', '$email', '$hash_pass', '$employee_id', '$date_of_birth', '$date_of_records')";
